...
function PatientPage() {
  ...
  const renderContent = () => {
    switch (activePage) {
      ...
      case 'history':
        return <History formType={activePage2.formType} email={location.state.email} />;
          ...
          <Container>
            ...
            <Navbar.Collapse id="navbarmain">
              ...
              <Nav.Link onClick={handleLogout} className="text-danger">Logout</Nav.Link>
                <Nav.Link onClick={() => setActivePage('feedback')}  className='nav-link allBtn' style={{color:"white",textAlign:"center",backgroundColor:"#332a7e"}}>Feedback</Nav.Link>
