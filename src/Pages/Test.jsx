        ...
        <Container>
          ...
          <Navbar.Collapse id="navbarmain">
            ...
            <Nav.Link onClick={handleLogout} className="text-danger">Logout</Nav.Link>
              ...
              <Nav.Link onClick={() => setActivePage('TestResult')}  className='nav-link allBtn' style={{color:"white",paddingTop:"20px",backgroundColor:"#332a7e"}}>TestResult</Nav.Link>
              <Nav.Link onClick={() => setActivePage('TestAppointment')}  className='nav-link allBtn' style={{color:"white",paddingTop:"20px",backgroundColor:"#332a7e"}}>TestAppointment</Nav.Link>


             

              {/* Example welcome message */}
              <Nav.Link>Welcome TestName</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
